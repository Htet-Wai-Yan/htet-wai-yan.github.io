...
const $$RootLayout = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(['<html data-theme="retro"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><script src="/htmx.min.js"><\/script>', '</head> <body> <div class="w-full p-4"> ', " </div> </body></html>"])), renderHead(), renderSlot($$result, $$slots["default"]));
