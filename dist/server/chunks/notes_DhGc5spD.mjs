...
import { o as generateCspDigest, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, p as removeBase, b as isRemotePath, q as unflatten, v as object, w as date, x as array, A as AstroError, y as UnknownContentCollectionError, z as string, m as maybeRenderHead, h as addAttribute } from './server_BoHFZHtL.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Diqac4Tr.mjs');
